...
class AssistsControllerTest < ActionController::TestCase
  ...
  test "should create assist" do
    assert_difference('Assist.count') do
      post :create, assist: { aTime: @assist.aTime, game_id: @assist.game_id, player_id: @assist.player_id }
    end
  ...
  test "should update assist" do
    patch :update, id: @assist, assist: { aTime: @assist.aTime, game_id: @assist.game_id, player_id: @assist.player_id }
    assert_redirected_to assist_path(assigns(:assist))
  end
